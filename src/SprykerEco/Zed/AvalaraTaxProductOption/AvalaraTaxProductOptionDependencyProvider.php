...
namespace SprykerEco\Zed\AvalaraTaxProductOption;
...
class AvalaraTaxProductOptionDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    protected function addMoneyFacade(Container $container): Container
    {
        $container->set(static::FACADE_MONEY, function (Container $container) {
            return new AvalaraTaxProductOptionToMoneyFacadeBridge($container->getLocator()->money()->facade());
        });
    ...
    protected function addUtilEncodingService(Container $container): Container
    {
        $container->set(static::SERVICE_UTIL_ENCODING, function (Container $container) {
            return new AvalaraTaxProductOptionToUtilEncodingServiceBridge($container->getLocator()->utilEncoding()->service());
        });
